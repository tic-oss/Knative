...
// API endpoint to send event to the new emitter function via broker
app.post("/test-new-emitter", (req, res) => {
  console.log(`----------------Logging Broker URL------------------`);
  console.log("BROKER URL: ", KnativeEventingBrokerUri);
  ...
  const ce = new CloudEvent({
    ...
    data: {
      reminder: [
        {
          _id: "659296d0649852c958fc6837",
          title: "a",
          description: "ancsndsad",
          user_id: "4c973896-5761-41fc-8217-07c5d13a004b",
          expired: false,
          date: "2024-01-02T12:12:00.000Z",
        },
        {
          _id: "659a9cb625e32ba5c54ae136",
          title: "aaaa",
          description: "sdasda",
          user_id: "4c973896-5761-41fc-8217-07c5d13a004b",
          expired: false,
  ...
  emit(ce)
    .then((response) => {
      console.log(`CloudEvent emitted!`, ce);
    })
    .catch((error) => {
      console.error("Error sending CloudEvent:", error);
    });
